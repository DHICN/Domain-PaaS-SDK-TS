...
// @ts-ignore
import { SetDefaultScenarioPara } from '../models'
// @ts-ignore
...
export const ScenarioManagerApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    /**
     *
     * @summary /api/v2/scenario-manager/scenario/default/display/set
     * @param {string} version
     * @param {SetDefaultScenarioPara} [setDefaultScenarioPara]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    apiV2ScenarioManagerScenarioDefaultDisplaySetPost: async (
      version: string,
      setDefaultScenarioPara?: SetDefaultScenarioPara,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'version' is not null or undefined
      assertParamExists('apiV2ScenarioManagerScenarioDefaultDisplaySetPost', 'version', version)
      const localVarPath = `/api/v2/scenario-manager/scenario/default/display/set`.replace(
        `{${'version'}}`,
        encodeURIComponent(String(version)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ScenarioManagerApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV2ScenarioManagerScenarioDefaultDisplaySetPost(
      version: string,
      setDefaultScenarioPara?: SetDefaultScenarioPara,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV2ScenarioManagerScenarioDefaultDisplaySetPost(
          version,
          setDefaultScenarioPara,
          options,
        )
...
export const ScenarioManagerApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV2ScenarioManagerScenarioDefaultDisplaySetPost(
      version: string,
      setDefaultScenarioPara?: SetDefaultScenarioPara,
      options?: any,
    ): AxiosPromise<object> {
      return localVarFp
        .apiV2ScenarioManagerScenarioDefaultDisplaySetPost(version, setDefaultScenarioPara, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
...
export class ScenarioManagerApi extends BaseAPI {
   ...
   * @memberof ScenarioManagerApi
   */
  public apiV2ScenarioManagerScenarioDefaultDisplaySetPost(
    version: string,
    setDefaultScenarioPara?: SetDefaultScenarioPara,
    options?: AxiosRequestConfig,
  ) {

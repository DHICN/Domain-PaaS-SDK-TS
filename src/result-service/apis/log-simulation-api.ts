...
export const LogSimulationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiV1ResultLogListGet: async (scenarioId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LogSimulationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1ResultLogListGet(scenarioId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LogSimulationItem>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1ResultLogListGet(scenarioId, options);
 ...
 * @export
 */
export const LogSimulationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ResultLogListGet(scenarioId?: string, options?: any): AxiosPromise<Array<LogSimulationItem>> {
            return localVarFp.apiV1ResultLogListGet(scenarioId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class LogSimulationApi extends BaseAPI {
    ...
    public apiV1ResultLogListGet(scenarioId?: string, options?: AxiosRequestConfig) {
        return LogSimulationApiFp(this.configuration).apiV1ResultLogListGet(scenarioId, options).then((request) => request(this.axios, this.basePath));
    }
}

...
export const M2DApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV2Result2dDynamicGet(
      scenarioId: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<M2DDynamicOutput>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiV2Result2dDynamicGet(
        scenarioId,
        options,
      )
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
...
export const M2DApiFactory = function (
  ...
  return {
    ...
    apiV2Result2dDynamicGet(scenarioId: string, options?: any): AxiosPromise<M2DDynamicOutput> {
      return localVarFp
        .apiV2Result2dDynamicGet(scenarioId, options)
        .then((request) => request(axios, basePath))
    },
  }
}

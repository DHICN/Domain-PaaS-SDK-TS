...
export const CatchmentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiV1ResultCatchmentRainfallRunoffGet: async (scenarioId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CatchmentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1ResultCatchmentRainfallRunoffGet(scenarioId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RainfallRunoffSummaryOutput>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1ResultCatchmentRainfallRunoffGet(scenarioId, options);
 ...
 * @export
 */
export const CatchmentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ResultCatchmentRainfallRunoffGet(scenarioId: string, options?: any): AxiosPromise<RainfallRunoffSummaryOutput> {
            return localVarFp.apiV1ResultCatchmentRainfallRunoffGet(scenarioId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CatchmentApi extends BaseAPI {
    ...
    public apiV1ResultCatchmentRainfallRunoffGet(scenarioId: string, options?: AxiosRequestConfig) {
        return CatchmentApiFp(this.configuration).apiV1ResultCatchmentRainfallRunoffGet(scenarioId, options).then((request) => request(this.axios, this.basePath));
    }
}

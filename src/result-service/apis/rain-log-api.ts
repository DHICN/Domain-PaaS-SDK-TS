...
export const RainLogApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiV1ResultRainGetGet: async (rainId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        apiV1ResultRainListBySingleTimeGet: async (rainTime: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        apiV1ResultRainListGet: async (startTime: string, endTime: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RainLogApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1ResultRainGetGet(rainId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryRainOutput>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1ResultRainGetGet(rainId, options);
         ...
         * @throws {RequiredError}
         */
        async apiV1ResultRainListBySingleTimeGet(rainTime: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<QueryRainOutput>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1ResultRainListBySingleTimeGet(rainTime, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 按时间查询降雨记录，只有在StartTime和EndTime之间开始的降雨记录会被返回，同时也会返回每个降雨记录对应的方案ID列表（每一场降雨记录都对应于若干个连续的自动预报方案） Query rainfall records by time, only rainfall records start between StartTime and EndTime will be returned, together with their associated scenario Ids. Each rainfall record corresponds to several continuous auto forecast scenarios.
         ...
         * @throws {RequiredError}
         */
        async apiV1ResultRainListGet(startTime: string, endTime: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<QueryRainOutput>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1ResultRainListGet(startTime, endTime, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
 ...
 * @export
 */
export const RainLogApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        apiV1ResultRainGetGet(rainId?: string, options?: any): AxiosPromise<QueryRainOutput> {
            return localVarFp.apiV1ResultRainGetGet(rainId, options).then((request) => request(axios, basePath));
        },
        /**
         * 按时间查询降雨记录，只有时间范围包含了查询时刻的降雨记录会被返回，同时也会返回每个降雨记录对应的方案ID列表（每一场降雨记录都对应于若干个连续的自动预报方案） Query rainfall records by time, only rainfall record contain the query time will be returned, together with their associated scenario Ids.  Each rainfall record corresponds to several continuous auto forecast scenarios.
         * @summary 查询降雨记录 Get rainfall record by time
         ...
         * @throws {RequiredError}
         */
        apiV1ResultRainListBySingleTimeGet(rainTime: string, options?: any): AxiosPromise<Array<QueryRainOutput>> {
            return localVarFp.apiV1ResultRainListBySingleTimeGet(rainTime, options).then((request) => request(axios, basePath));
        },
        /**
         * 按时间查询降雨记录，只有在StartTime和EndTime之间开始的降雨记录会被返回，同时也会返回每个降雨记录对应的方案ID列表（每一场降雨记录都对应于若干个连续的自动预报方案） Query rainfall records by time, only rainfall records start between StartTime and EndTime will be returned, together with their associated scenario Ids. Each rainfall record corresponds to several continuous auto forecast scenarios.
         * @summary 查询降雨的记录 Query rainfall records
         ...
         * @throws {RequiredError}
         */
        apiV1ResultRainListGet(startTime: string, endTime: string, options?: any): AxiosPromise<Array<QueryRainOutput>> {
            return localVarFp.apiV1ResultRainListGet(startTime, endTime, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RainLogApi extends BaseAPI {
    ...
    public apiV1ResultRainGetGet(rainId?: string, options?: AxiosRequestConfig) {
        return RainLogApiFp(this.configuration).apiV1ResultRainGetGet(rainId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public apiV1ResultRainListBySingleTimeGet(rainTime: string, options?: AxiosRequestConfig) {
        return RainLogApiFp(this.configuration).apiV1ResultRainListBySingleTimeGet(rainTime, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public apiV1ResultRainListGet(startTime: string, endTime: string, options?: AxiosRequestConfig) {
        return RainLogApiFp(this.configuration).apiV1ResultRainListGet(startTime, endTime, options).then((request) => request(this.axios, this.basePath));
    }
}

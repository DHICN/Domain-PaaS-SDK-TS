 ...
 *
 * @export
 * @interface ModelBoundaryConfigFormat
 */
export interface ModelBoundaryConfigFormat {
  /**
   * 配置项ID configuration id
   * @type {string}
   * @memberof ModelBoundaryConfigFormat
   */
  id?: string
  /**
   ...
   * @memberof ModelBoundaryConfigFormat
   */
  boundaryType?: ModelBoundaryConfigFormatBoundaryTypeEnum
  /**
...
export const ModelBoundaryConfigFormatBoundaryTypeEnum = {
  '1': 1 as number,
  '2': 2 as number,
  '3': 3 as number,
  '4': 4 as number,
...
export type ModelBoundaryConfigFormatBoundaryTypeEnum =
  (typeof ModelBoundaryConfigFormatBoundaryTypeEnum)[keyof typeof ModelBoundaryConfigFormatBoundaryTypeEnum]

  ...
  return {
    ...
    async apiV2CodeConfigImportConfigExcelPost(
      ...
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV2CodeConfigImportConfigExcelPost(
          excelFile,
          sheets,
          options,
        )
...
export const ImportExportApiFactory = function (
  ...
  return {
    ...
    apiV2CodeConfigImportConfigExcelPost(
      ...
      return localVarFp
        .apiV2CodeConfigImportConfigExcelPost(excelFile, sheets, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ImportExportApi extends BaseAPI {
   ...
   * @memberof ImportExportApi
   */
  public apiV2CodeConfigImportConfigExcelPost(
    excelFile?: any,
    sheets?: string,
    options?: AxiosRequestConfig,
  ) {

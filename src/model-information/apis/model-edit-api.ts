...
// @ts-ignore
import { BatchAddOrUpdateBoundaryTsInput } from '../models'
// @ts-ignore
...
// @ts-ignore
import { GetMultipleBoundariesInput } from '../models'
// @ts-ignore
...
export const ModelEditApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    /**
     *
     * @summary 批量查询边界时序数据/Batch query boundary timing data
     * @param {GetMultipleBoundariesInput} [getMultipleBoundariesInput]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    apiV1ModelInformationBoundaryGetMultipleTimeseriesPost: async (
      getMultipleBoundariesInput?: GetMultipleBoundariesInput,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/v1/model-information/boundary/get-multiple-timeseries`
    ...
    /**
     *
     * @summary 批量新增或者批量更新方案的边界时间序列数据/Batch add or batch update the boundary time series data of the scheme
     * @param {BatchAddOrUpdateBoundaryTsInput} [batchAddOrUpdateBoundaryTsInput]
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    apiV1ModelInformationBoundaryTimeseriesBatchAddOrUpdatePost: async (
      batchAddOrUpdateBoundaryTsInput?: BatchAddOrUpdateBoundaryTsInput,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/v1/model-information/boundary/timeseries/batch-add-or-update`
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
      ...
      localVarRequestOptions.data = serializeDataIfNeeded(
        batchAddOrUpdateBoundaryTsInput,
        localVarRequestOptions,
        configuration,
      )
...
export const ModelEditApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV1ModelInformationBoundaryGetMultipleTimeseriesPost(
      getMultipleBoundariesInput?: GetMultipleBoundariesInput,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GetBoundaryTsOutput>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1ModelInformationBoundaryGetMultipleTimeseriesPost(
          getMultipleBoundariesInput,
          options,
        )
     ...
     * @throws {RequiredError}
     */
    async apiV1ModelInformationBoundaryTimeseriesBatchAddOrUpdatePost(
      batchAddOrUpdateBoundaryTsInput?: BatchAddOrUpdateBoundaryTsInput,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<boolean>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1ModelInformationBoundaryTimeseriesBatchAddOrUpdatePost(
          batchAddOrUpdateBoundaryTsInput,
          options,
        )
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
...
export const ModelEditApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1ModelInformationBoundaryGetMultipleTimeseriesPost(
      getMultipleBoundariesInput?: GetMultipleBoundariesInput,
      options?: any,
    ): AxiosPromise<Array<GetBoundaryTsOutput>> {
      return localVarFp
        .apiV1ModelInformationBoundaryGetMultipleTimeseriesPost(getMultipleBoundariesInput, options)
     ...
     * @throws {RequiredError}
     */
    apiV1ModelInformationBoundaryTimeseriesBatchAddOrUpdatePost(
      batchAddOrUpdateBoundaryTsInput?: BatchAddOrUpdateBoundaryTsInput,
      options?: any,
    ): AxiosPromise<boolean> {
      return localVarFp
...
export class ModelEditApi extends BaseAPI {
   ...
   */
  public apiV1ModelInformationBoundaryGetMultipleTimeseriesPost(
    getMultipleBoundariesInput?: GetMultipleBoundariesInput,
    options?: AxiosRequestConfig,
  ) {
   ...
   * @memberof ModelEditApi
   */
  public apiV1ModelInformationBoundaryTimeseriesBatchAddOrUpdatePost(
    batchAddOrUpdateBoundaryTsInput?: BatchAddOrUpdateBoundaryTsInput,
    options?: AxiosRequestConfig,
  ) {
    return ModelEditApiFp(this.configuration)

...
// @ts-ignore
import { CarbonFootprintOutput } from '../models'
// @ts-ignore
...
// @ts-ignore
import { DosageOfMedicationOutput } from '../models'
// @ts-ignore
...
export const GeneralDataApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    apiGeneralDataCarbinFootprintGet: async (
      modelName?: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/GeneralData/CarbinFootprint`
     ...
     * @throws {RequiredError}
     */
    apiGeneralDataDosageOfMedicationGet: async (
      modelName?: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/GeneralData/DosageOfMedication`
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
     ...
     * @param {Array<string>} [productLines] 产线
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    apiGeneralDataGetAssemblyConfigsGet: async (
      ...
      if (productLines !== undefined) {
        localVarQueryParameter['productLines'] = productLines
      }
...
export const GeneralDataApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiGeneralDataCarbinFootprintGet(
      modelName?: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CarbonFootprintOutput>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiGeneralDataCarbinFootprintGet(
        modelName,
        options,
      )
     ...
     * @throws {RequiredError}
     */
    async apiGeneralDataDosageOfMedicationGet(
      modelName?: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DosageOfMedicationOutput>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiGeneralDataDosageOfMedicationGet(
        modelName,
        options,
      )
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)
...
export const GeneralDataApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiGeneralDataCarbinFootprintGet(
      modelName?: string,
      options?: any,
    ): AxiosPromise<Array<CarbonFootprintOutput>> {
      return localVarFp
        .apiGeneralDataCarbinFootprintGet(modelName, options)
     ...
     * @throws {RequiredError}
     */
    apiGeneralDataDosageOfMedicationGet(
      modelName?: string,
      options?: any,
    ): AxiosPromise<Array<DosageOfMedicationOutput>> {
      return localVarFp
        .apiGeneralDataDosageOfMedicationGet(modelName, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * 根据展示类型获取点位配置信息
...
export class GeneralDataApi extends BaseAPI {
   ...
   */
  public apiGeneralDataCarbinFootprintGet(modelName?: string, options?: AxiosRequestConfig) {
   ...
   * @memberof GeneralDataApi
   */
  public apiGeneralDataDosageOfMedicationGet(modelName?: string, options?: AxiosRequestConfig) {
    return GeneralDataApiFp(this.configuration)
      .apiGeneralDataDosageOfMedicationGet(modelName, options)
      .then((request) => request(this.axios, this.basePath))
  }

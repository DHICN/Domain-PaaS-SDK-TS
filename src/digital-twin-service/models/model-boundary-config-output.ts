 ...
 *
 * @export
 * @interface ModelBoundaryConfigOutput
 */
export interface ModelBoundaryConfigOutput {
  /**
   * 配置项ID configuration id
   * @type {string}
   * @memberof ModelBoundaryConfigOutput
   */
  id?: string
  /**
  ...
  /**
   * 对应的设备指标信息 corresponding device indicators
   * @type {Array<BoundaryConfigPointItem>}
   * @memberof ModelBoundaryConfigOutput
   */
  pointJson?: Array<BoundaryConfigPointItem> | null
  /**
   *
   ...
   * @memberof ModelBoundaryConfigOutput
   */
  boundaryType?: ModelBoundaryConfigOutputBoundaryTypeEnum
  /**
...
export const ModelBoundaryConfigOutputBoundaryTypeEnum = {
  '1': 1 as number,
  '2': 2 as number,
  '3': 3 as number,
  '4': 4 as number,
...
export type ModelBoundaryConfigOutputBoundaryTypeEnum =
  (typeof ModelBoundaryConfigOutputBoundaryTypeEnum)[keyof typeof ModelBoundaryConfigOutputBoundaryTypeEnum]

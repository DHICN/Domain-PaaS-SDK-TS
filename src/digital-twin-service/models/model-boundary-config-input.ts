 ...
 *
 * @export
 * @interface ModelBoundaryConfigInput
 */
export interface ModelBoundaryConfigInput {
  /**
   * 配置项ID configuration id
   * @type {string}
   * @memberof ModelBoundaryConfigInput
   */
  id?: string | null
  /**
   ...
   * @memberof ModelBoundaryConfigInput
   */
  boundaryType?: ModelBoundaryConfigInputBoundaryTypeEnum
  /**
...
export const ModelBoundaryConfigInputBoundaryTypeEnum = {
  '1': 1 as number,
  '2': 2 as number,
  '3': 3 as number,
  '4': 4 as number,
...
export type ModelBoundaryConfigInputBoundaryTypeEnum =
  (typeof ModelBoundaryConfigInputBoundaryTypeEnum)[keyof typeof ModelBoundaryConfigInputBoundaryTypeEnum]

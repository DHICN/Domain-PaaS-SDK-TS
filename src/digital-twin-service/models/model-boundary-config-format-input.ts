 ...
 *
 * @export
 * @interface ModelBoundaryConfigFormatInput
 */
export interface ModelBoundaryConfigFormatInput {
  /**
   * 配置项ID configuration id
   * @type {string}
   * @memberof ModelBoundaryConfigFormatInput
   */
  id?: string | null
  /**
   ...
   * @memberof ModelBoundaryConfigFormatInput
   */
  boundaryType?: ModelBoundaryConfigFormatInputBoundaryTypeEnum
  /**
...
export const ModelBoundaryConfigFormatInputBoundaryTypeEnum = {
  '1': 1 as number,
  '2': 2 as number,
  '3': 3 as number,
  '4': 4 as number,
...
export type ModelBoundaryConfigFormatInputBoundaryTypeEnum =
  (typeof ModelBoundaryConfigFormatInputBoundaryTypeEnum)[keyof typeof ModelBoundaryConfigFormatInputBoundaryTypeEnum]
